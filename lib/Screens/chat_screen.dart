  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      if (_selectedImage != null && message.isNotEmpty) {
        final uri = Uri.parse('http://192.168.1.107:8000/multimodal');
        ...
        final uri = Uri.parse('http://192.168.1.107:8000/image');
        final request = http.MultipartRequest('POST', uri);
        request.headers['Authorization'] = 'Bearer $token';
        request.files.add(
        ...
        final uri = Uri.parse('http://192.168.1.107:8000/query');
